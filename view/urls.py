...
from .views import EventAndOffersAPIView, PlacesAPIView , SearchAPI , GetAddOrDeleteFavouriteView , GetAddOrDeleteCommentView ,PLaceDetailsAPIView,AddRateAPIView , GetAddOrDeleteInterrestView,SearchCityAPI
...
urlpatterns = [
    ...
    path('interrest/',GetAddOrDeleteInterrestView.as_view(),),
    path('searchcity/',SearchCityAPI.as_view(),),
